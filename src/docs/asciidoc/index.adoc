...
== 상품 삭제
==== `DELETE` /api/item//delete/itemId=:itemId
operation::item/delete-item[snippets='http-request,path-parameters,http-response,response-fields']

== 상품 옵션 삭제
==== `GET` /api/item/delete/itemDetail=:itemDetailId
operation::item/delete-item[snippets='http-response,path-parameters,response-fields']
