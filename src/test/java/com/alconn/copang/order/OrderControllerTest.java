...
//                .role(Role.CLIENT)
    ...
    private RequestFieldsSnippet getRequestFieldsSnippet() {
        return relaxedRequestFields(
            ...
            fieldWithPath("orderItems.[].itemDetailId").type(JsonFieldType.NUMBER)
                .description("옵션 식별자"),
            fieldWithPath("orderItems.[].optionName").type(JsonFieldType.STRING).description("옵션명")
                .optional(),
            fieldWithPath("orderItems.[].optionValue").type(JsonFieldType.STRING).description("옵션값")
                .optional(),
            ...
            fieldWithPath("orderItems.[].unitTotal").type(JsonFieldType.NUMBER)
                .description("개별상품 합산 금액")
        );
    }
    ...
    private ResponseFieldsSnippet getResponseFieldsSnippet() {
        return relaxedResponseFields(
            ...
            fieldWithPath("data.totalAmount").description(JsonFieldType.NUMBER)
                .description("상품 총 갯수"),
            fieldWithPath("data.address").type(JsonFieldType.OBJECT).description("주소정보"),
            fieldWithPath("data.address.addressId").type(JsonFieldType.NUMBER)
                .description("주소 식별자"),
            ...
            fieldWithPath("data.address.receiverPhone").type(JsonFieldType.STRING)
                .description("받는사람 전화번호"),
            fieldWithPath("data.address.receiverName").type(JsonFieldType.STRING)
                .description("받는사람 이름"),
            ...
            fieldWithPath("data.orderItems.[].itemId").type(JsonFieldType.NUMBER)
                .description("아이템 식별자"),
            fieldWithPath("data.orderItems.[].itemDetailId").type(JsonFieldType.NUMBER)
                .description("옵션 식별자"),
            fieldWithPath("data.orderItems.[].optionName").type(JsonFieldType.STRING)
                .description("옵션명"),
            fieldWithPath("data.orderItems.[].optionValue").type(JsonFieldType.STRING)
                .description("옵션값"),
            fieldWithPath("data.orderItems.[].price").type(JsonFieldType.NUMBER).description("가격"),
            fieldWithPath("data.orderItems.[].amount").type(JsonFieldType.NUMBER)
                .description("개별 상품수량"),
            fieldWithPath("data.orderItems.[].unitTotal").type(JsonFieldType.NUMBER)
                .description("개별상품 합산 금액")
        );
    }
    ...
    private ResponseFieldsSnippet getResponseFieldsSnippetList() {
        return relaxedResponseFields(
            ...
            fieldWithPath("data[].address.receiverName").type(JsonFieldType.STRING)
                .description("받는사람 이름"),
            fieldWithPath("data[].address.preRequest").type(JsonFieldType.STRING)
                .description("요청사항"),
            fieldWithPath("data[].client").type(JsonFieldType.OBJECT).description("주문자 정보"),
            fieldWithPath("data[].client.clientId").type(JsonFieldType.NUMBER)
                .description("주문자 식별자"),
            fieldWithPath("data[].client.username").type(JsonFieldType.STRING)
                .description("주문자 아이디"),
            fieldWithPath("data[].client.phone").type(JsonFieldType.STRING).description("주문자 전화번호"),
            fieldWithPath("data[].client.realName").type(JsonFieldType.STRING)
                .description("주문자 이름"),
            fieldWithPath("data[].orderItems").type(JsonFieldType.ARRAY).description("주문 아이템 리스트"),
            fieldWithPath("data[].orderItems.[].itemName").type(JsonFieldType.STRING)
                .description("상품명"),
            ...
            fieldWithPath("data[].orderItems.[].optionValue").type(JsonFieldType.STRING)
                .description("옵션값"),
            fieldWithPath("data[].orderItems.[].price").type(JsonFieldType.NUMBER)
                .description("가격"),
            fieldWithPath("data[].orderItems.[].amount").type(JsonFieldType.NUMBER)
                .description("개별 상품수량"),
            fieldWithPath("data[].orderItems.[].unitTotal").type(JsonFieldType.NUMBER)
